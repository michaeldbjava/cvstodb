 ...
 *
 */
public class CsvToDbErrorHandlingConfigFile implements ErrorHandler {

	/**
	 * 
	 */
	public CsvToDbErrorHandlingConfigFile() {
	...
	public void error(SAXParseException exception) throws SAXException {
		...
		throw new SAXException("****    Beim Parse Vorgang ist ein Fehler aufgetreten!");
	...
	public void fatalError(SAXParseException exception) throws SAXException {
		...
		throw new SAXException("****    Beim Parse Vorgang ist ein fataler Fehler aufgetreten!");
	}
