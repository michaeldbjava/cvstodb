...
//			System.out.println("Übergebener Pfad: " + pathOfConfigFile);
			...
			if (configFileExists == true) {
				...
				try {
					 ...
					 * Primärschlüsselspalten enthalten
					 */
					 ...
					 * Spalten, für das PreparedStatement
					 */
...
//					System.out.println(columnUpdateList);
					 ...
					 * ich hier jetzt Prepared Statements verwende, müssen diese
					 * zunächst mit in die ? Stellvertreterlist für Werte mit
					 * aufgenommen werden.
					 * 
...
//								System.out.println("VARBINARY Typ is not supported");
						...
						/*
						 * Das müssen wir uns noch mal gut Ausdrücke, die in der
